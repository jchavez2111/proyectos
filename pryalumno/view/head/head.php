    ...
    <div class="container-fluid bg-dark p-2 mb-3">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="/pryalumno/index.php">Inicio</a>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/pryalumno/view/alumno/index.php">Alumno</a></li>
                                <li><a class="dropdown-item" href="/pryalumno/view/alumno/create.php">Agregar nuevos alumnos</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
